...
@section('content')
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">REPORTE DE TASA DE INCIDENCIAS</h6>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                          ...
                                          <div class="card-body">
                                                <div class="px-3">
                                                  <form action="" method="post" name="reporte_incidencia" id="reporte_incidencia"  class="form-horizontal row-border"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-actions">
                                                              <button type="submit" class="btn btn-success reporte_incidencia">
                                            ...
                                            <div class="card-body collapse show">
                                             ...
                                             <div id="guia" style="background-color:#FFF; padding:0px;">
                                              ...
                                              <table width="100%" >
                                              <tr>
                                              <td align="center"><b>REPORTE DE TASA DE INCIDENCIAS</b>
                                              </td>
                                              </tr>
                                              </table>
                                                  ...
                                                  <table width="100%" style="border:solid 1px #CCC;width:99%">
                                                     <tr>
                                                              ...
                                                              <th style="text-align:left;font-size: 12px">INCIDENCIAS GENERADAS</th>
                                                              
                                                              <th style="text-align:left;font-size: 12px">TOTAL DE SALIDAS</th>
                                                              <th style="text-align:left;font-size: 12px">TASA DE INCIDENCIAS</th>
                                                     ...
                                                     <tbody>
                                                       ...
                                                       ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:left;font-size: 12px">
                                                                 @foreach($salidas_mensajes as $salidas_mensaje)
                                                                    @if($salidas_mensaje->fecha == $item->fecha)
                                                                       
                                                                           <?php $cantidad_mensajes++; ?>
                                                                        
                                                                    @endif
                                                                  @endforeach
                                                                <?php echo $cantidad_mensajes; ?>
                                                            </td>
                                                            ...
                                                            <td style="text-align:left;font-size: 12px">
                                                                 <?php echo number_format($cantidad_mensajes/$cantidad_total*100,2); ?> %
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                      </tbody>
