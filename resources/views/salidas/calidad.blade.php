...
@section('content')
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">REPORTE DE CALIDAD DE PEDIDOS GENERADOS</h6>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                          ...
                                          <div class="card-body">
                                                <div class="px-3">
                                                  <form action="" method="post" name="reporte_calidad" id="reporte_calidad"  class="form-horizontal row-border"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-actions">
                                                              <button type="submit" class="btn btn-success reporte_calidad">
                                            ...
                                            <div class="card-body collapse show">
                                             ...
                                             <div id="guia" style="background-color:#FFF; padding:0px;">
                                              ...
                                              <table width="100%" >
                                              <tr>
                                              <td align="center"><b>REPORTE DE CALIDAD DE PEDIDOS GENERADOS</b>
                                              </td>
                                              </tr>
                                              </table>
                                                  ...
                                                  <table width="100%" style="border:solid 1px #CCC;width:99%">
                                                     <tr>
                                                              ...
                                                              <th style="text-align:left;font-size: 12px">PEDIDOS ENTREGADOS SIN PROBLEMAS</th>
                                                              
                                                              <th style="text-align:left;font-size: 12px">TOTAL DE PEDIDOS GENERADOS</th>
                                                              <th style="text-align:left;font-size: 12px">CALIDAD DE PEDIDOS GENERADOS</th>
