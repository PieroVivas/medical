...
@section('content')
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">REPORTE DE GANANCIA POSITIVA</h6>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                          ...
                                          <div class="card-body">
                                                <div class="px-3">
                                                  <form action="" method="post" name="reporte_ganancia" id="reporte_ganancia"  class="form-horizontal row-border"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-actions">
                                                              <button type="submit" class="btn btn-success reporte_ganancia">
                                                                <i class="icon-note"></i> BUSCAR
                                                              </button>
                                                              <a href="{{ url('indicador_ganancia_consolidado/2020-01-01/2020-12-30') }}" class="btn btn-success">
                                                                <i class="icon-note"></i> CONSOLIDADO
                                                              </a>
                                              ...
                                              <td align="center"><b>REPORTE DE GANANCIA POR PRODUCTO FILTRADO POR MES Y AÑO</b>
                                                  ...
                                                  <table width="100%" style="border:solid 1px #CCC;width:99%">
                                                     <tr>
                                                              ...
                                                              <th style="text-align:left;font-size: 12px">PRECIO COMPRA</th>
                                                              <th style="text-align:left;font-size: 12px">PRECIO VENTA</th>
