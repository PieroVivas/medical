...
@section('content')
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">REPORTE DE NÚMERO DE UNIDADES DESPACHADAS POR EMPLEADO</h6>
                                          ...
                                          <div class="card-body">
                                            ...
                                            <div class="card-body collapse show">
                                             ...
                                             <div id="guia" style="background-color:#FFF; padding:0px;">
                                              ...
                                              <table width="100%" >
                                              <tr>
                                              <td align="center"><b>REPORTE DE NÚMERO DE UNIDADES DESPACHADAS POR EMPLEADO</b>
                                              </td>
                                              </tr>
                                              </table>
                                                  ...
                                                  <table width="100%" style="border:solid 1px #CCC;width:99%">
                                                     <tr>
                                                              ...
                                                              <th style="text-align:left;font-size: 12px">TOTAL DE UNIDADES DESPACHADAS</th>
                                                              
                                                              <th style="text-align:left;font-size: 12px">TOTAL DE EMPLEADOS</th>
                                                              <th style="text-align:left;font-size: 12px">INDICADOR</th>
                                                       ...
                                                       ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:left;font-size: 12px">
                                                                ...
                                                                <?php echo $cantidad_total=3; ?>
                                                            </td>

                                                            <td style="text-align:left;font-size: 12px">
                                                                 <?php echo $cantidad_total_estados/$cantidad_total; ?>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                      </tbody>
