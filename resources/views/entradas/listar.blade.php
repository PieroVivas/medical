                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            ...
                            <div class="widget-body clearfix">
                                ...
                                <form action="" method="post" name="agregar_entrada" id="agregar_entrada"   enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="numero" name="numero"  value="OI-000{{ $cantidad_entradas*1+1 }}" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                         ...
                                         <div class="col-md-3">
                                            <button class="btn btn-primary btn-rounded guardar_entrada" type="submit" style="margin-top:40px">Registrar Entrada</button>
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="color:black;vertical-align:middle">
                                                @foreach($proveedores as $proveedor)
                                                    @if($proveedor->id==$item->fkproveedor)
                                                        {{$proveedor->razon}}
                                                    @endif
                                                @endforeach
                                            ...
                                            <td style="color:black;vertical-align:middle"><?php echo date("d/m/y",strtotime($item->fecha)); ?></td>
                                             ...
                                             <td>
                                            <a href="{{ URL::to('entradas/' . $item->id . '/edit') }}"  class="btn btn-small btn-info" 
                                              >EDITAR 
                                            </a>
                                           </td>
                                          ...
                                          <td>
                                             <button class="btn btn-small btn-info eliminar_entrada"    data-id="{{ $item->id }}" >
                                                ELIMINAR 
                                              </button>
                                            </td>
